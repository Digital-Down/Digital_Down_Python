...
class MindHarvestNetwork:
	...
	def horizontal(cls, wav_file):
		...
		video_writer = cv2.VideoWriter('output.mp4', fourcc, fps, resolution)
		...
		# Release video writer and close wave file
		video_writer.release()
		wav.close()

	@classmethod
	def vertical(cls, wav_file):
		# Parameters
		wav_file
		fps = 30
...
#MindHarvestNetwork.horizontal('Amphetamine -1.wav')