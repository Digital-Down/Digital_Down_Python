...
class SinglePhaseExtraction:
    ...
    @classmethod
    def convert(cls, audio_data, oscillations, threshold=100, max_threshold=32767, channel=0, phase='positive'):
        positive_count = 0
        negative_count = 0
        current_oscillation = []
        ...
        for i, sample in enumerate(audio_data):
            ...
            if (phase == 'positive' and value <= 0 and positive_count > 0) or \
               (phase == 'negative' and value >= 0 and negative_count > 0):
                ...
                total_count = positive_count if phase == 'positive' else negative_count
