...
if __name__ == "__main__":
    song = "Example Song"
    input_wav_path = f"C:/Amphetamine.wav"
    base_output_path = 'D:/Audio/'
    
    TemporalDissectionSynthesis.TDSSlow(input_wav_path, f'{base_output_path}')
    TemporalDissectionSynthesis.TDSFast(input_wav_path, f'{base_output_path}')