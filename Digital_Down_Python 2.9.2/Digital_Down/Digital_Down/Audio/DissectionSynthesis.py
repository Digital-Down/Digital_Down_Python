...
if __name__ == "__main__":
    song = "With No Eyes"
    input_wav_path = f"D:/5th Generation (When Desktop Is Full)/Audio/Stems and Mixes for Future Edits/#Released/Nervous System/Open Source Nervous System/Stems/Vocals.wav"
    base_output_path = 'D:/5th Generation (When Desktop Is Full)/Audio/Projects/Dissection Synthesis/Individual Stems/'
    
    DissectionSynthesis.OctavePlus(input_wav_path, f'{base_output_path}')
