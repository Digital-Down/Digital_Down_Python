...
from .SinglePhaseExtraction import *
        ...
        try:
            ...
            if extraction_method == "Extraction Synthesis":
                if self.normalize.get():
                    output_messages = ExtractionSynthesis.process_audio_folder_normalize(
                    ...
                    output_messages = ExtractionSynthesis.process_audio_folder(
                        input_folder, output_folder, incomplete_folder=output_folder,
                        threshold=min_threshold, max_threshold=max_threshold,
                        methylphenethylamine=methylphenethylamine
                    )
...
#Exe string in command prompt: pyinstaller --onefile --windowed --hidden-import=Audio.ExtractionSynthesis --hidden-import=Audio.AudioSampleValues --add-data "Background.png;." "Extraction Synthesis 1.5.2.py"